...
export function About() {
  ...
  const stats = [
    { value: '2025', label: 'Founded', description: 'Year established' },
    { value: '5', label: 'Core Modules', description: 'Unified platform' },
    { value: '6', label: 'Team Members', description: 'Engineering & product' },
  ];
  ...
  const team = [
    ...
    {
      title: 'AI Infrastructure Experts',
      description: 'We\'ve built and scaled infrastructure for training LLMs, running inference at massive scale, and optimizing GPU clusters.',
      stats: ['Managed 100K+ GPUs', 'Trained billion-parameter models', 'Built ML platforms'],
    },
    {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Stats */}
      <section className="relative py-12 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-black font-bold text-base mb-1">{stat.label}</div>
